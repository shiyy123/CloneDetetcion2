...
//        String baseDir = "/home/cary/Documents/Data/CloneData/";
        ...
        String funPath = baseDir + File.separator + "cfg/func.txt";
        try {
...
//                    p2.waitFor();
                ...
                String dotDir = baseDir + File.separator + "dot" + File.separator + (i / 500) + "/";
                ...
                bufferedWriter.write("echo " + func_id + " | joern-plot-proggraph -cfg > " + dotDir + File.separator + func_id + ".dot;");
                bufferedWriter.newLine();
